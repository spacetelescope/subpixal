...
import subpixal
release = "{:s} ({:s})".format(subpixal.__version__, subpixal.__version_date__)
...
latex_documents = [
  ('index', 'subpixal.tex', u'subpixal Documentation',
   u'Mihai Cara', 'manual'),
]
...
man_pages = [
    ('index', 'subpixal', u'subpixal Documentation',
     [author], 1)
]
...
texinfo_documents = [
  ('index', 'subpixal.tex', u'subpixal Documentation',
   author, 'index', 'subpixal Documentation',
   'Miscellaneous'),
]
...
epub_title = u'subpixal'
epub_author = author
epub_publisher = u'STScI'
epub_copyright = copyright

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'subpixal'
